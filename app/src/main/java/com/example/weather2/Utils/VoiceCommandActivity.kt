...
//                FirebaseWindowBlinds.updateStatusAutomatic(1)
//                Toast.makeText(this, content, Toast.LENGTH_SHORT).show()
//                speakResponse(content)
//                return
//            }
...
//                FirebaseWindowBlinds.updateStatusAutomatic(0)
//                Toast.makeText(this, content, Toast.LENGTH_SHORT).show()
//                speakResponse(content)
//                return
//            }
...
//                FirebaseWindowBlinds.updateStatus(1)
//                Toast.makeText(this, content, Toast.LENGTH_SHORT).show()
//                speakResponse(content)
//                return
//            }
...
//                FirebaseWindowBlinds.updateStatus(0)
//                Toast.makeText(this, content, Toast.LENGTH_SHORT).show()
//                speakResponse(content)
//                return
//            }
